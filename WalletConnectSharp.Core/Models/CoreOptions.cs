...
namespace WalletConnectSharp.Core.Models
{
    ...
    public class CoreOptions
    {
        ...
        /// </summary>
        [JsonProperty("context")] public string BaseContext;
        ...
        /// </summary>
        [JsonProperty("storage")] public IKeyValueStorage Storage;
        ...
        /// </summary>
        [JsonProperty("keychain")] public IKeyChain KeyChain;

        /// <summary>
        /// The <see cref="IConnectionBuilder"/> interface to use inside the Relayer to build
        /// new websocket connections.
        /// </summary>
        [JsonProperty("connectionBuilder")] public IConnectionBuilder ConnectionBuilder;
